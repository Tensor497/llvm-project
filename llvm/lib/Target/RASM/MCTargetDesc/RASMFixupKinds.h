//===- RASMFixupKinds.h - RASM Specific Fixup Entries -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RASM_MCTARGETDESC_RASMFIXUPKINDS_H
#define LLVM_LIB_TARGET_RASM_MCTARGETDESC_RASMFIXUPKINDS_H
...
// MCFixupKindInfo Infos[RASM::NumTargetFixupKinds] in
// RASMAsmBackend.cpp.
//
enum Fixups {
  // Define fixups can be handled by RASMAsmBackend::applyFixup.
